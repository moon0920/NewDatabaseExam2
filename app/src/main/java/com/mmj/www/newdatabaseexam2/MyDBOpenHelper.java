package com.mmj.www.newdatabaseexam2;
...
//        Toast.makeText(this.,"onUpgrade", Toast.LENGTH_LONG).show();
        db.execSQL("CREATE TABLE awe_country (pkid PRIMARY KEY AUTOINCREMENT, country TEXT, capital TEXT);");
        db.execSQL("CREATE TABLE awe_country_visit (fkid PRIMARY KEY AUTOINCREMENT);");
